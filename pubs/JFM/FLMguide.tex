...
\begin{figure}
    ...
    \caption{Radiated velocity potential of discretized (stepped) and slanted geometries.\textcolor{red}{Need to add a0, b), .., so we can refer to each plot within this figure.}}
    \label{fig:potential outline comparison}
\end{figure}
