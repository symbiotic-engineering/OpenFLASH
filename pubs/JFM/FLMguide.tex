...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figs/alpha-beta-explain-placeholder.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figs/choosing-fitting-functions-placeholder.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figs/final-fitting-functions-placeholder.jpg}
    ...
    \label{fig:final-fitting-functions}
\end{figure}
...
\begin{bmhead}[Author ORCIDs.]{R. McCabe, https://orcid.org/0000-0001-5108-998X; C. Treacy, https://orcid.org/0009-0000-9381-2697}
\end{bmhead}
