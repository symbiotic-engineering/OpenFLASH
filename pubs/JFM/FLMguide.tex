...
\begin{figure}
    ...
    \caption{[TODO: Mention that relative error scaling is zeroed for potential $<$ 1, clarify relative error is for real potential, label colorbars, swap error colorbar to percents, pick inner outline or crossing outline.]
    Radiated velocity potential of discretized (stepped) and slanted geometries.\textcolor{red}{Need to add a0, b), .., so we can refer to each plot within this figure.}}
    \label{fig:potential comparison plots}
\end{figure}
