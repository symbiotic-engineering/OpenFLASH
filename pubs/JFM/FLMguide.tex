...
\begin{itemize}
    \item Literature review. Written by \textcolor{teal}{Becca}.
    \item Brief introduction of each section of the paper. Written by \textcolor{teal}{Becca}.
\end{itemize}
...
\section{Convergence of Hydrodynamic Coefficients}
...
\section{Slanted Geometries}\label{sec:Slanted Geometries}
...
\section{Computation Time and Accuracy}
\begin{itemize}
