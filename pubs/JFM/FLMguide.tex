...
\subsection{Caching}
A common application of a hydrodynamics solver is assessing multiple geometries in the same environment (same $h$, same range of frequencies), so $\lambda_n^e$ values can be cached over such runs.
