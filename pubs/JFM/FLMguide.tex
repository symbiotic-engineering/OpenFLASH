...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{figs/MEEM_vs_Capytaine_Slant_Validation_and_Convergence.pdf}
    \caption{Added mass and radiation damping coefficients from MEEM and Capytaine for CorPower-like WEC geometry with slanted region. $\textbf{Replace dummy data with real data.}$}
    \label{fig:MEEM nonslant validation}
\end{figure} 
