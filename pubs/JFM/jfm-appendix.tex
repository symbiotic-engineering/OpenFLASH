...
where 
\begin{equation}
    \gls{sym-vec-R-1-ell}(\gls{sym-r})=[R_{10}^\ell(\gls{sym-r}), R_{11}^\ell(\gls{sym-r}),\dots, \gls{sym-R-1-N-ell-1-ell}(\gls{sym-r}) ]
\end{equation}
and
\begin{equation}
     \gls{sym-vec-R-2-ell}(\gls{sym-r})=[R_{20}^\ell(\gls{sym-r}), R_{21}^\ell(\gls{sym-r}),\dots, \gls{sym-R-2-N-ell-1-ell}(\gls{sym-r}) ] 
\end{equation}
...
\begin{table}
    ...
    \\ \hline \hline 
      ...
      \shortstack{
        ...
        $N^{i_{m+1}}$
        & 
        $ \mathbf{1}_{N^{i_{m+1}}1} \gls{sym-vec-R-1-i-m}$ 
        & 
        $ \mathbf{1}_{N^{i_{m+1}}1} \gls{sym-vec-R-2-i-m}$ 
        & 
        $\mathbf{1}_{N^{i_{m+1}}1}  \frac{\partial}{\partial \gls{sym-r}} \gls{sym-vec-R-1-i-m-1}$ 
        & 
        $\mathbf{1}_{N^{i_{m+1}}1}  \frac{\partial}{\partial \gls{sym-r}} \gls{sym-vec-R-2-i-m-1}$ 
        \\ \hline
    \end{tabular}
