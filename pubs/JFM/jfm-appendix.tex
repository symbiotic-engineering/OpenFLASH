...
\end{equation}
It is not desired to change the bounds of the right-hand-side because $\gls{sym-phi-s}$ is not meaningfully defined on $\gls{sym-z}\in(-\gls{sym-d-mathrm-s},-\gls{sym-d-mathrm-t})$.
...
\begin{table}
    ...
    \\ \hline
      ...
      $\gls{sym-N-i-m-2}$
      & 
      $\mathbf{1}_{\gls{sym-N-i-m-2}1} \frac{\partial}{\partial \gls{sym-r}} \gls{sym-vec-R-1-i-m-2}$ 
      & 
      $\mathbf{1}_{\gls{sym-N-i-m-2}1} \frac{\partial}{\partial \gls{sym-r}} \gls{sym-vec-R-2-i-m-2}$ 
      & 
...
\begin{aligned}
    ...
    &= 2 \gls{sym-pi} \gls{sym-rho} \sum_{\gls{sym-m} \in \gls{sym-mathcal-M-p}} \int_{\gls{sym-a-m}}^{\gls{sym-a-m-1}} \ _{}^{\gls{sym-q}}\gls{sym-phi-i-m}(\gls{sym-r},-\gls{sym-d-m}) \ r  \ dr \\
    &= 2 \gls{sym-pi} \gls{sym-rho} \sum_{\gls{sym-m} \in \gls{sym-mathcal-M-p}} \Bigg[
    \int_{\gls{sym-a-m}}^{a_{{m+1}}} \ _{}^{\gls{sym-q}}\gls{sym-phi-i-m-p}(\gls{sym-r},-\gls{sym-d-m})\, \gls{sym-r}\, dr \\
...
\begin{aligned}\relax
    ...
    & = \int_{\gls{sym-a-m}}^{a_{{m+1}}} \gls{sym-R-1n-m-i-m}(\gls{sym-r})\, \gls{sym-r}\, dr \\
    & = \left\{\begin{matrix}
...
\begin{aligned}\relax
    ...
    & = \int_{\gls{sym-a-m}}^{a_{{m+1}}} \gls{sym-R-2n-m-i-m}(\gls{sym-r})\, \gls{sym-r}\, dr \\
    & = \left\{\begin{matrix}
