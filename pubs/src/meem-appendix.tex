...
Further numeric and realization details of the authors' implementation may be found in \cite{bimali_numerics_2026,best_openflash_2026,mccabe_open-source_2024}.
...
\begin{figure}[htbp]
\centering
\input{figs/tikz/meem_dims.tikz}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figs/from-matlab/meem_sparsity.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figs/from-matlab/meem_validation.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figs/from-matlab/meem_matching.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figs/from-matlab/meem_convergence_vs_omega.pdf}
    \caption{Convergence for $N=M=K=(5,10,20,30)$ for RM3}
...
\begin{figure}
    \centering
    \includegraphics[width=.75\linewidth]{figs/from-matlab/asymptotic_b_vector.pdf}
...
For $N=M=K=10$, the simulation averages \results[MEEMRuntime] on a Windows 10 laptop with a 2.5 GHz Intel i9 processor for a single frequency.
