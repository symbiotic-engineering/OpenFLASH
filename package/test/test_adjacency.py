...
print("Automatic adjacency matrix:")
print(geom_auto.adjacency_matrix.astype(int))

# Expected output (chain i1 <-> i2 <-> i3 <-> e):
# [[0 1 0 0]
#  [1 0 1 0]
#  [0 1 0 1]
#  [0 0 1 0]]
...
print(geom_manual.adjacency_matrix.astype(int))

# Now adjacency reflects the manual specification instead of the automatic chain
